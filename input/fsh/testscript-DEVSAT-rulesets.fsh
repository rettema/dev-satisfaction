...
* insert TSTestAssertWithProp("Confirm that the returned response payload is the specified resource.", #response, false, false, resource, #{resource})
* insert TSTestAssertWithProp("Confirm that the returned resource conforms to the specified profile.", #response, false, false, validateProfileId, "{profile_id}")
