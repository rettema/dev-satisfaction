...
* insert TSMetadata({instance_name}, http://touchstone.aegis.net/touchstone/fhir/dev-satisfaction, {date}, "Example TestScript to test {profile_description} resource read and profile validation using {return_type} format")
* insert TSOrigin(1)
